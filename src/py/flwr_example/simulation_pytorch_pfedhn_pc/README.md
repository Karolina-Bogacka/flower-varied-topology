# This example is a modified version of the PyTorch simulation example.
# It is meant to explain and demonstrate how to properly use the personalized Federated Learning with Hypernetworks example
