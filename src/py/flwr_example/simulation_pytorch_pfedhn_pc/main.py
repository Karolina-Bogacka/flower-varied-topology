...
from pfedhn import pFedHN, pFedHN_PC

from utils import Net, train, test, CNNHyper, CIFARHyper
...
if __name__ == "__main__":
    ...
    embed_dim = int(1 + pool_size / 4)
    inner_hnet = CNNHyper(n_nodes=pool_size, embedding_dim=embed_dim)
    outer_hnet = CIFARHyper(inner_hnet)

    strategy = pFedHN_PC(
        hypernetwork=outer_hnet,
        fraction_fit=0.1,
